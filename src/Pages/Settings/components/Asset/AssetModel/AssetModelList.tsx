...
const columnHelper = createColumnHelper<AssetModel>();
...
interface AssetModelListProps {
  data: AssetModel[];
  setDeleteAssetModelId: (id: number) => void;
  setUpdateAssetModel: (model: AssetModel) => void;
  deleteModal: any;
  updateModal: any;
  createModal: any;
}
...
const AssetModelList = ({
  ...
  useEffect(() => {
    pageTitleStore.setPageTitle("Asset Models ");
  }, []);
              ...
              <Tr key={row.id} bg={index % 2 != 0 ? "Neutral.100" : "white"}>
                ...
                <Td>
                  <IconButton
                    ...
                    icon={<EditIcon />}
                    onClick={() => {
                      setUpdateAssetModel(row.original);
                      updateModal.onOpen();
                    }}
                    variant={"outline"}
                    size={"sm"}
                  ...
                  <IconButton
                    ...
                    icon={<DeleteIcon />}
                    onClick={() => {
                      setDeleteAssetModelId(row.original.id || 0);
                      deleteModal.onOpen();
                    }}
                    variant={"outline"}
                    size={"sm"}
