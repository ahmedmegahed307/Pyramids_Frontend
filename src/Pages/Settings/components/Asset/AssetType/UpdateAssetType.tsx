...
export type UpdateAssetTypeValidation = z.infer<typeof schema>;
type UserFormProps = {
  onSubmit: (data: UpdateAssetTypeValidation) => void;
  defaultValue: AssetType;
};

const UpdateAssetType = ({ onSubmit, defaultValue }: UserFormProps) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  } = useForm<UpdateAssetTypeValidation>({
  ...
  const handleFormSubmit = (data: UpdateAssetTypeValidation) => {
    onSubmit(data);
    //reset();
  };
