...
interface ProductCategoryListProps {
  ...
  setDeleteProductCategoryId: (id: number) => void;
  setUpdateProductCategory: (model: ProductCategory) => void;
  deleteModal: any;
  updateModal: any;
  createModal: any;
}
              ...
              <Tr key={row.id} bg={index % 2 != 0 ? "Neutral.100" : "white"}>
                ...
                <Td>
                  <IconButton
                    ...
                    icon={<EditIcon />}
                    onClick={() => {
                      setUpdateProductCategory(row.original);
                      updateModal.onOpen();
                    }}
                    variant={"outline"}
                    size={"sm"}
                  ...
                  <IconButton
                    ...
                    icon={<DeleteIcon />}
                    onClick={() => {
                      setDeleteProductCategoryId(row.original.id || 0);
                      deleteModal.onOpen();
                    }}
                    variant={"outline"}
                    size={"sm"}
